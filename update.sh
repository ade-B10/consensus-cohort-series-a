...
SOURCE_FILE="source/Consensus_Cohort_Series_A.html"
OUTPUT_FILE="index.html"
TEMPLATE_TITLE="Base10 · Series A Consensus Cohort & DNA"
INSTRUCTIONS="Enter the password to access Base10 · Series A Consensus Cohort & DNA."
